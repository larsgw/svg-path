...
export function normalizePolygonDirection (polygon) {
  // see https://stackoverflow.com/a/1165943/5095300
  const clockwise = polygon.reduce((counter, [x1, y1], i) => {
    const [x2, y2] = polygon[i + 1] || polygon[0]
    return counter + (x2 - x1) * (y2 + y1)
  }, 0)
